 ...
 * @return char* A new, dynamically allocated sanitized string, or NULL on error or if input is
 * NULL. The caller is responsible for freeing the returned string.
 */
